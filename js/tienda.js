...
var disminuir_dropSection = () => {
  ...
  document.addEventListener("dragover", dragover=(event)=> event.preventDefault());
...
// -------- Functions -----------
// Función que modifica el tamaño de las imágenes cuando la pantalla es menor o igual a 480px
const modifySizes = () =>{
    if(window.innerWidth <= 480){
        for(var j=0; j< items.length; j++){
            // De esta manera, para pantallas pequeñas las imágenes de los productos serán más o menos cuadradas
...
// Llamamos a la función una vez así no exista un resize
modifySizes();

// -------- Evento -------------
// Evento que se ejecuta cuando hay un resize de la pantalla
window.addEventListener('resize', modifySizes);